...
const Cliente = new SQL.Table();
const Direccion = new SQL.Table();
const GrupoSolidario = new SQL.Table();
const UTD_CLIE_Clientes = new SQL.Table();
const UDT_CLIE_Individual = new SQL.Table();
const UDT_CLIE_Solicitud = new SQL.Table();
const UDT_CLIE_DatoBancario = new SQL.Table();
const UDT_CLIE_ReferenciasPersonales = new SQL.Table();
const UDT_CLIE_DetalleSeguro = new SQL.Table();
const UDT_CLIE_TuHogarConConservaCoacreditado = new SQL.Table();
const UDT_CONT_CURP = new SQL.Table();
const UDT_CONT_Direcciones = new SQL.Table();
const UDT_CONT_DireccionContacto = new SQL.Table();
const UDT_CONT_Empresa = new SQL.Table();
const UDT_CONT_FirmaElectronica = new SQL.Table();
const UDT_CONT_Identificaciones = new SQL.Table();
const UDT_CONT_IFE = new SQL.Table();
const UDT_CONT_Negocios = new SQL.Table();
const UDT_CONT_Oficinas = new SQL.Table();
const UDT_CONT_Persona = new SQL.Table();
const UDT_CONT_Telefonos = new SQL.Table();
const UDT_OTOR_GarantiaPrendaria = new SQL.Table();
const UDT_OTOR_TuHogarConConserva = new SQL.Table();
const UDT_Solicitud = new SQL.Table();
const UDT_SolicitudDetalle = new SQL.Table();
const UDT_SPLD_DatosCliente = new SQL.Table();
...
// UDT_Solicitud.columns.add('seguro_cuotas', SQL.Bit, { nullable: true });
//#endregion
...
module.exports = {
    UDT_CONT_Persona: UDT_CONT_Persona,
    UDT_CONT_Identificaciones: UDT_CONT_Identificaciones,
    UDT_CONT_Telefonos: UDT_CONT_Telefonos,
    UDT_CONT_Negocios: UDT_CONT_Negocios,
    UTD_CLIE_Clientes: UTD_CLIE_Clientes,
    UDT_CLIE_Individual: UDT_CLIE_Individual,
    UDT_CLIE_Solicitud: UDT_CLIE_Solicitud,
    UDT_CLIE_DatoBancario: UDT_CLIE_DatoBancario,
    UDT_SPLD_DatosCliente: UDT_SPLD_DatosCliente,
    UDT_CONT_FirmaElectronica: UDT_CONT_FirmaElectronica,
    UDT_Solicitud: UDT_Solicitud,
    Cliente: Cliente,
    GrupoSolidario: GrupoSolidario,
    Direccion: Direccion,
    UDT_SolicitudDetalle: UDT_SolicitudDetalle,
    UDT_CLIE_DetalleSeguro: UDT_CLIE_DetalleSeguro,
    UDT_CLIE_ReferenciasPersonales: UDT_CLIE_ReferenciasPersonales,
    UDT_OTOR_GarantiaPrendaria: UDT_OTOR_GarantiaPrendaria,
    UDT_OTOR_TuHogarConConserva: UDT_OTOR_TuHogarConConserva,
    UDT_CLIE_TuHogarConConservaCoacreditado: UDT_CLIE_TuHogarConConservaCoacreditado,
    UDT_CONT_DireccionContacto: UDT_CONT_DireccionContacto,
    UDT_CONT_CURP: UDT_CONT_CURP,
    UDT_CONT_IFE: UDT_CONT_IFE,
    UDT_CONT_Empresa: UDT_CONT_Empresa,
    UDT_CONT_Direcciones: UDT_CONT_Direcciones,
    UDT_CONT_Oficinas: UDT_CONT_Oficinas,
